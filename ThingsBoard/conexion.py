...
# Configurar el cliente MQTT para ThingsBoard
tb_client = mqtt.Client()
tb_client.username_pw_set(username=thingsboard_username, password=thingsboard_password)  
tb_client.connect(thingsboard_mqtt_host, thingsboard_mqtt_port)
...
def GetDeviceStatus():
    ...
    response = requests.get(url, auth=(thingsboard_username, thingsboard_password))
